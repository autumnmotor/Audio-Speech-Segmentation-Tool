...
## 使い方
まず、python環境に、ソースの冒頭にあるライブラリ、pydub, nousereduce, numpyをインストールしてください。
...
| --compressor | コンプレッサーによる圧縮率 | ratio | 2.0 |
| --noise_reduction | ノイズ除去率 | prop | 0.3 |
...
- チャンネルのモノラル化（備考を見よ）
- データ型のint32化（ディザが出来ないのでデータ型を拡張してお茶をにごす）
